...
JMessagePlugin.prototype.getSingleConversationHistoryMessage = function (username, from, limit, successCallback, errorCallback) {
  this.callNative("getSingleConversationHistoryMessagegetSingleConversationHistoryMessage", [username, from, limit], successCallback, errorCallback);
};
...
JMessagePlugin.prototype.onReceivedSingleConversationMessage = function (data) {
  try {
    ...
    console.log("onSingleConversationMessageReceived " + JSON.stringify(bToObj));
  }
  catch (exception) {
